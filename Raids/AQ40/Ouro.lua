...
L:RegisterTranslations("frFR", function() return {
	...
	--sweep_cmd = "sweep",
	sweep_name = "Alerte de Balayage",
	sweep_desc = "Avertit pour le Balayage",

	--sandblast_cmd = "sandblast",
	sandblast_name = "Alerte de SandBlast",
	sandblast_desc = "Avertit pour le Sandblast",

	--emerge_cmd = "emerge",
	emerge_name = "Alerte d'Emergement",
	emerge_desc = "Avertit quand Ouro va Emerger",

	--submerge_cmd = "submerge",
	submerge_name = "Alerte de Submersion",
	submerge_desc = "Avertit quand Ouro va se Submerger",

	--berserk_cmd = "berserk",
	berserk_name = "Berserk",
	berserk_desc = "Averit quand Ouro passe en Berserk",

	sweeptrigger = "Ouro commence \195\160 lancer Balayer.",
	sweepannounce = "Balayage!",
	sweepwarn = "Balayage dans 5 sec!",
	sweepbartext = "Balayage",

	sandblasttrigger = "Ouro commence \195\160 ex\195\169cuter Explosion de sable.",
	sandblastannounce = "Explosion de sable!",
	sandblastwarn = "5 secondes avant Explosion de sable!",
	sandblastbartext = "Explosion de sable Possible",

	engage_message = "Ouro engagé! Submersion Possible dans 90sec!",
	possible_submerge_bar = "Submersion Possible",

	--emergetrigger = "Dirt Mound casts Summon Ouro Scarabs.",
	emergetrigger = "Tas de terre lance Invocation de Scarab\195\169es d'Ouro.",

	emergeannounce = "Ouro apparait!",
	emergewarn = "15 sec avant une submersion possible!",
	emergebartext = "Ouro Submerge",

	--submergetrigger = "Ouro casts Summon Ouro Mounds.",
	submergetrigger = "Ouro lance Invocation de Monticules d'Ouro.",
	submergeannounce = "Ouro disparait!",
	submergewarn = "5 secondes avant que Ouro Emerge!!",
	submergebartext = "Ouro Emerge",

	berserktrigger = "Ouro gagne Enrager.",
	berserkannounce = "Enrager!",
	berserksoonwarn = "Enrager bientôt - Preparez vous!",
